// Bare utilities that are layout on their own.
...
const LAYOUT_PREFIXES = new Set([
  ...
  "order", "basis", "col", "col-span", "col-start", "col-end", "row", "row-span",
  "grid-cols", "grid-rows", "aspect", "overflow", "overflow-x", "overflow-y",
  "gap", "gap-x", "gap-y", "space-x", "space-y",
  "m", "mx", "my", "mt", "mr", "mb", "ml", "ms", "me",
  "p", "px", "py", "pt", "pr", "pb", "pl", "ps", "pe",
  "w", "h", "size", "min-w", "max-w", "min-h", "max-h",
  "inset", "inset-x", "inset-y", "top", "right", "bottom", "left", "z",
]);
...
/** Every string literal reachable from an expression, with the node it came from. */
