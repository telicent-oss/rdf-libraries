...
import { DCATResourceSchema } from "../../apiFactory/operations/utils/common";

export const ACLEDTriples = z.array(RDFTripleSchema).parse([
  {
    "o": {
      "type": "literal",
      "value": "All rights to use ACLED data or analysis are conditioned on the user’s adherence to the use restri…"
    },
    "p": {
      "type": "uri",
  ...
  },
  {
    "o": {
      "type": "literal",
      "value": "All political violence events, demonstration events,and strategic developments recorded in Africa …"
    },
    "p": {
      "type": "uri",
      "value": "http://purl.org/dc/terms/description"
