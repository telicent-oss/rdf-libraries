 ...
 *
 * Two details decide whether this answers correctly, and both bit during development:
 *
 ...
 */
export function pullGitignored({ repo, refs, subpath, dest, cwd, writeShaFile = true }) {
  ...
  try {
    for (const ref of refs) {
      const result = shallowClone(repo, ref);
